...
2.生成镜像
#在本地生成带私服前缀的镜像
docker build -t 10.19.13.20:5000/yc-common:v1.0 .   (每次打镜像前版本号要更新)
#将镜像推送到私服
docker push 10.19.13.20:5000/yc-common:v1.0
...
#进入容器，查看镜像内部的情况
docker exec -it yc-common /bin/bash
#删除运行的容器
docker rm -fv yc-common
